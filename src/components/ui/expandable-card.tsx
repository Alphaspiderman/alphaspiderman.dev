...
interface IExpandableCardBodyProps extends React.ComponentProps<
  typeof motion.div
> {
  children: React.ReactNode;
  className?: string;
...
interface IExpandableCardContentProps extends React.ComponentProps<
  typeof motion.div
> {
  children: React.ReactNode;
  className?: string;
...
interface IExpandableCardTitleProps extends React.ComponentProps<
  typeof motion.h2
> {
  children: React.ReactNode;
  className?: string;
...
interface IExpandableCardDescriptionProps extends React.ComponentProps<
  typeof motion.h3
> {
  children: React.ReactNode;
  className?: string;
...
interface IExpandableCardImageProps extends React.ComponentProps<
  typeof motion.img
> {
  className?: string;
}
...
interface IExpandableCardCloseButtonProps extends React.ComponentProps<
  typeof MotionButton
> {}
